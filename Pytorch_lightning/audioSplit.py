...
offgridType = "reverb"
offgrid = "Ordered_files_off_grid_"+ offgridType +"\\Ordered_files_off_grid_"+ offgridType +"\\Obstructed_Top\\Line_of_Sight\\"
...
recordingsList = []
for i in numbers:
    recordingsList.append(headDir +offgrid+ recordings + str(i) + "\\" + suffix)
