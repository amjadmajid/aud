...
def evaluate_signals(signals: list) -> float:
    ...
    for i, signal in enumerate(signals):
        for j, s in enumerate(signals):
            ...
            if i == j:
                pass
                #max_auto_correlation.append(get_max_correlation(s, signal))

    return np.max(max_cross_correlations)
...
def main():
    ...
    model.run(set_function=ga.set_function_multiprocess(evaluate_matrix, n_jobs=12), start_generation=samples)
